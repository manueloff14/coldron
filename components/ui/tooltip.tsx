...
function TooltipContent({
  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="z-50 size-2.5 translate-y-[calc(-50%_-_1px)] rotate-45 rounded-[2px] border-r border-b border-white/10 bg-[#0f141b] fill-[#0f141b]" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  );
}
